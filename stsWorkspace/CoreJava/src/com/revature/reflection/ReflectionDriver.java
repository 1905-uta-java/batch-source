...
public class ReflectionDriver {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//access fields from super of Cat
			System.out.println("super fields:");
			Field[] fields2 = c1.getSuperclass().getDeclaredFields();
			for(Field f: fields2) {
				System.out.println(f);
			}
			...
			//create an instance of Cat class and modify it
			...
			setWhiskersMethod.invoke(cat, 500);
			System.out.println(cat);
