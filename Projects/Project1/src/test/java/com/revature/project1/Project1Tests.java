...
public class Project1Tests {
	...
	public static void addEmployee(int employeeID, String firstName, String lastName, String title, int managerID, String email, String phone, String password, Date hireDate, String address, String city, String state, String country, String postalCode) {
