...
INSERT INTO CHINOOK.EMPLOYEE(EmployeeId, LastName, FirstName, Title, BirthDate, HireDate, Address, City, State, Country, PostalCode, Phone, Fax, Email) 
VALUES (1, 'Mann', 'Horace', 'Historical Figure', TO_DATE('1796-5-04 00:00:00','yyyy-mm-dd hh24:mi:ss'), TO_DATE('1848-4-3 00:00:00','yyyy-mm-dd hh24:mi:ss'), '1 Not Canada W', 'Edmonton', 'AB', 'Canada', 'T5K 3N4', null, null, 'hmann@chinookcorp.com');
...
CREATE OR REPLACE FUNCTION MEDIATYPE_NAME_LENGTH
    ...
    BEGIN
        ...
        WHERE TABLE_NAME = 'MEDIATYPE' AND COLUMN_NAME = 'NAME';
        RETURN RET;
    END;
...
--B: SELECTS A TRACK THAT HAS THE BIGGEST PRICE IN TRACK TABLE
CREATE OR REPLACE FUNCTION EXPENSIVE_TRACK
    ...
    BEGIN
        ...
        INTO EXPENSE
        FROM CHINOOK.TRACK;
        SELECT CHINOOK.TRACK.TRACKID
        INTO TID
        FROM CHINOOK.TRACK
        WHERE CHINOOK.TRACK.UNITPRICE = EXPENSE
            AND ROWNUM = 1;
        RETURN TID;
    END;
...
EXEC UPD_EMPLOYEE_RECORD(10, '2 NOT CANADA WAY', 'TORONTO', 'NA', 'T2C 4Z1', '+1 (800) 999-9999', '+1 (800) 999-9999', 'hmann@chinookcorp.com');
...
DECLARE
    CID NUMBER;
    CFIRST CHINOOK.CUSTOMER.FIRSTNAME%TYPE;
    CLAST CHINOOK.CUSTOMER.LASTNAME%TYPE;
    CCOMP CHINOOK.CUSTOMER.COMPANY%TYPE;
BEGIN
    CID := 10;
    GET_CUSTOMER_DATA(CID,CFIRST,CLAST,CCOMP);
    DBMS_OUTPUT.PUT_LINE(CFIRST || ' '|| CLAST || ' ' || CCOMP);
END;
--6.0 TRANSACTIONS
...
BEGIN
    ...
    COMMIT;
END;
-- CHECK  TABLE FOR PROOF OF CONCEPT.
-- DELINVOICE(411);
